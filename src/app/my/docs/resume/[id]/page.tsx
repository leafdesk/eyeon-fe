...
export default function ResumeDocPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0F1626] text-white flex flex-col">
      ...
      {/* Header */}
      <Header title="내 문서 양식" right="voice" left="/my/docs/resume" />

      {/* Title */}
      <div className="text-center pt-6 pb-4">
        <h1 className="text-lg font-semibold mb-4">이력서</h1>
      ...
      <section className="fixed bottom-0 px-5 py-3 w-full space-y-3">
        ...
        <Button
          ...
          onClick={() => router.push(`/my/docs/resume/${docId}/ai`)}
        >
          AI 문서 요약본
        </Button>
      </section>
